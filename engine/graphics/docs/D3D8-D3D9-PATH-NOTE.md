...
- DXMT D3D11 headless smoke remains green through feature levels 10_0-11_1,
  ...
  UAV clear readbacks, groupshared/interlocked compute readback, D3D11.1
...
groupshared/interlocked compute readback, constant-buffer partial updates,
...
two-pass stability
(`artifacts/dxmt-smoke-logs/lane-d-stability-groupshared-atomic-20260604-162315.outer.log`).
