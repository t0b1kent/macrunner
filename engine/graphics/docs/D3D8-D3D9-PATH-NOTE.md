...
- DXMT D3D11 headless smoke remains green through feature levels 10_0-11_1,
  ...
  UAV clear readbacks, multi-UAV, buffer/texture SRV-to-UAV,
  texture-array/3D UAV, and groupshared/interlocked compute readbacks, D3D11.1
...
multi-UAV, buffer/texture SRV-to-UAV, texture-array/3D UAV, and
...
two-pass stability
(`artifacts/dxmt-smoke-logs/lane-d-stability-texture3d-uav-20260604-204730.outer.log`).
