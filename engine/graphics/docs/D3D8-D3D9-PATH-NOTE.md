...
- DXMT D3D11 headless smoke remains green through feature levels 10_0-11_1,
  ...
  UAV clear readbacks, multi-UAV, buffer/texture SRV-to-UAV, and groupshared/interlocked compute readbacks, D3D11.1
...
multi-UAV, buffer/texture SRV-to-UAV, and groupshared/interlocked compute readbacks, constant-buffer partial updates,
