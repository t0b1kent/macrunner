...
if [[ -n "${TRACE:-}" ]]; then
  ...
  traces=(
    ...
    "$ROOT/traces/runtime_samples/d3d8_renderware_texture_blend_runtime.jsonl"
	    ...
	    "$ROOT/traces/runtime_samples/d3d9_ffp_blendcurrentalpha_runtime.jsonl"
	    "$ROOT/traces/runtime_samples/d3d9_ffp_blenddiffusealpha_runtime.jsonl"
...
for result in results:
    ...
    min_pixels = {
        ...
        "d3d8_renderware_texture_blend_runtime.jsonl": 1200,
    }.get(trace_name, 1000)
