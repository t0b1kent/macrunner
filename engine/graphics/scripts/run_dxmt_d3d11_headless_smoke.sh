...
SUMMARY_FOCUS_PATTERN="UnityFeatureProbe|dynamic_constant|partial_constant|constant_partial_words|UnitySRGBSampleProbe|array_slice[01]_mip1_rgba|array_slice[01]_mip1_copy_rgba|typed_buffer_values"
