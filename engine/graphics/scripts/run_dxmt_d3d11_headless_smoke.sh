...
SUMMARY_PATTERN="DXMTProbe|LoadLibraryExW|loaded_.*_path|GetProcAddress|CreateDXGIFactory1|factory_probe|EnumAdapters|adapter_probe|RegisterClassExW|CreateWindowExW|window_create|window_visible|D3D11CreateDevice|feature_level|UnityFeatureLevelProbe|UnityDeviceInterfaceProbe|CheckFormatSupport|format_support|UnityFormatProbe|CreateSwapChainForHwnd|IDXGISwapChain::GetBuffer|GetContainingOutput|GetDesc1|desc1|GetFullscreenDesc|fullscreen_desc|GetHwnd|GetFullscreenState|SetFullscreenState|GetFrameStatistics|D3DCompile\\(gs_5_0\\)|CreateGeometryShader|CreateGeometryShaderWithStreamOutput|gs_bytecode_magic|Emulate stream output|CreateEmulatedVertexStreamOutputShader|GeometryShaderDraw|StreamOutputDraw|StreamOutputVerify|stream_output_staging|UnitySRGBProbe|UnityMSAAProbe|UnityResidencyProbe|UnityStabilityProbe|UnityStateProbe|UnityGammaProbe|UnityQueryProbe|UnityDeferredProbe|UnityQueryDeferredProbe|TIMESTAMP_DISJOINT|PIPELINE_STATISTICS|GetPredication|disjoint_frequency|UnityDeferredResourceProbe|UnityTessellationProbe|UnityMRTProbe|UnityMultithreadProbe|UnityBatchProbe|CreateClassLinkage|CreateHullShader|CreateDomainShader|CreateTexture1D|CreateTexture2D|CreateShaderResourceView|CreateUnorderedAccessView|CreateBuffer\\(raw\\)|Map\\(dynamic_vertex_no_overwrite\\)|CopySubresourceRegion|GenerateMips|mip0_rgba|mip1_rgba|ResolveSubresource|CreateRenderTargetView|ClearRenderTargetView|CreateDepthStencilView|ClearDepthStencilView|ClearView|DiscardView|OMSetRenderTargetsAndUnorderedAccessViews|Present|Present1|Readback|pixel0_bgra|pixel_readback|c0000135|err:module|not found|failed|FAIL"
