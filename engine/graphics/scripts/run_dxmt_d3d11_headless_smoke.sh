...
SUMMARY_FOCUS_PATTERN="UnityFeatureProbe|dynamic_constant|partial_constant|constant_partial_words|overlap_copy|constant_offset|CSSetConstantBuffers1|CSGetConstantBuffers1|PIPELINE_STATISTICS pending|SO_STATISTICS pending|SO_OVERFLOW_PREDICATE pending|ClearView\\(depth_|UnitySRGBSampleProbe|array_slice[01]_mip1_rgba|array_slice[01]_mip1_copy_rgba|typed_buffer_values"
