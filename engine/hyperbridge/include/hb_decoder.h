...
typedef struct {
    ...
    enum {
        ...
        HB_INS_SHL, HB_INS_SHR, HB_INS_SAR, HB_INS_ROL, HB_INS_ROR, HB_INS_SHLD, HB_INS_SHRD,
        HB_INS_CMP, HB_INS_TEST, HB_INS_CMPXCHG, HB_INS_CMPXCHG8B, HB_INS_XCHG, HB_INS_XADD,
        HB_INS_PUSH, HB_INS_POP, HB_INS_PUSHF, HB_INS_POPF,
        HB_INS_CALL, HB_INS_RET, HB_INS_JMP, HB_INS_Jcc, HB_INS_LOOP, HB_INS_JRCXZ,
        ...
        HB_INS_BSF, HB_INS_TZCNT, HB_INS_LZCNT, HB_INS_BSR, HB_INS_BSWAP, HB_INS_SSE_MOV,
