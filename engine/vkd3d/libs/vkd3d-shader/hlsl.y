...
static bool add_uav_counter_method_call(struct hlsl_ctx *ctx, struct hlsl_block *block, struct hlsl_ir_node *object,
        const char *name, const struct parse_initializer *params, const struct vkd3d_shader_location *loc)
{
    struct hlsl_resource_load_params load_params = {0};
    ...
    load_params.type = !strcmp(name, "IncrementCounter")
            ? HLSL_RESOURCE_COUNTER_INCREMENT : HLSL_RESOURCE_COUNTER_DECREMENT;
    load_params.resource = object;
