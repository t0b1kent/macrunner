...
STAMP=$(date +%H%M%S)
RUNDIR="$ROOT/reports/phase4-hollow-knight/laneA-registryfix-verify-30-try1-$STAMP"
mkdir -p "$RUNDIR"
...
# is the right order.
export MACRUNNER_HB_JIT_DIRECT_MEM='0'
export MACRUNNER_HB_JIT_DIRECT_XMM_MEM='0'
export MACRUNNER_HB_JIT_DIRECT_SCALAR_MEM='0'
export MACRUNNER_HB_JIT_DIRECT_SCALAR_SCAN='1'
export MACRUNNER_HB_JIT_DIRECT_STACK='0'
...
export MACRUNNER_MR_RUN_PREFIX_TEMPLATE='/Users/timurtoby/Documents/MacRunner/Main/MacRunner/artifacts/hk-windows-oracle-prefix-template-20260721-225722-v3'
...
echo "run30 registry-fix verify rundir=$RUNDIR"
