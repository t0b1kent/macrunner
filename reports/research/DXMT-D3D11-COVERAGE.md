...
| Unity resource probes | PASS | Color texture + SRV/RTV/update/copy/readback, dynamic vertex buffer map, immutable constant buffer, depth DSV, R32_UINT UAV, 3D texture SRV, cubemap SRV, Texture2DArray SRV/RTV, Texture2DArray mip-slice update/copy/readback, and structured buffer SRV/UAV all return success; `artifacts/dxmt-smoke-logs/lane-d-array-mip-copy-20260604-124727.outer.log` verifies `array_slice0_mip1_copy_rgba=68,136,204,255` and `array_slice1_mip1_copy_rgba=68,136,204,255`. |
