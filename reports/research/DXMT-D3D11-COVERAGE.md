...
render/resolve, shader corpus coverage, bitblt/flip swapchain variants,
live-window present, fullscreen enter/restore state, resize, readback, and
vkd3d prefix deployment.
...
| Next Phase 4/5 evidence | Next | Add visible/full-display fullscreen correctness, extracted real-game shader corpus coverage, and real Unity present once the external x64 runtime blocker clears. |
