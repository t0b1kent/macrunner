...
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-observer-20260713-NOT_GOLDEN"
...
OBSERVER_SHA="39227983425d1b9d740cf141bdbe1d21bf68ef02c3fcac9d2d769fff7713ca0b"
...
if [ "$(shasum -a 256 "$OBSERVER_DLL" | awk '{print $1}')" != "$OBSERVER_SHA" ] ||
...
if [ "$(shasum -a 256 "$RUNTIME_DLL" | awk '{print $1}')" != "$OBSERVER_SHA" ]; then
...
echo "DEPLOYED_RUNTIME_SHA=$OBSERVER_SHA" >> "$OUT/RUNTIME-STATUS.txt"
(
    cd "$ROOT"
