#!/usr/bin/env bash
# ABZU ABBA heap-CS observer — attempt 5 (NOT_GOLDEN, diagnostic only).
...
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-observer-20260713e"
...
OBSERVER_DLL="$OUT/OBSERVER-ntdll-abzu-v3.dll"
RUNTIME_DLL="$DIST/lib/wine/aarch64-windows/ntdll.dll"
BACKUP_DLL="$OUT/PRE-OBSERVER-ntdll.dll"
OBSERVER_SHA="ed96c32d6cff08e6f611cd6378a7f691431aeb476c203ff2c22ffd28f848caab"
