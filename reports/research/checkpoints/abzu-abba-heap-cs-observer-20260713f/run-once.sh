#!/usr/bin/env bash
# ABZU ABBA heap-CS observer — attempt 6 (NOT_GOLDEN, diagnostic only).
...
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-observer-20260713f"
...
OBSERVER_DLL="$OUT/OBSERVER-ntdll-abzu-v4.dll"
RUNTIME_DLL="$DIST/lib/wine/aarch64-windows/ntdll.dll"
BACKUP_DLL="$OUT/PRE-OBSERVER-ntdll.dll"
OBSERVER_SHA="35ddf3a05b15babc3c82ead1e84ba34655b15bc5ec3acb6a6d0e81a1b02baf91"
