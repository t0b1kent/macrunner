#!/usr/bin/env bash
# ABZU ABBA heap-CS observer — attempt 7 (NOT_GOLDEN, diagnostic only).
...
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-observer-20260713g"
...
OBSERVER_DLL="$OUT/OBSERVER-ntdll-abzu-v5.dll"
RUNTIME_DLL="$DIST/lib/wine/aarch64-windows/ntdll.dll"
BACKUP_DLL="$OUT/PRE-OBSERVER-ntdll.dll"
OBSERVER_SHA="d4a899f359b8a478b20f607f29f254de0160d3b1a8f22f4b1b3320d5b6df0637"
