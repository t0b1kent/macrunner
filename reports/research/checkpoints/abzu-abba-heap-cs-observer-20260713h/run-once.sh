#!/usr/bin/env bash
# ABZU ABBA heap-CS observer — attempt 8 (NOT_GOLDEN, diagnostic only).
...
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-observer-20260713h"
...
OBSERVER_DLL="$OUT/OBSERVER-ntdll-abzu-v6.dll"
RUNTIME_DLL="$DIST/lib/wine/aarch64-windows/ntdll.dll"
BACKUP_DLL="$OUT/PRE-OBSERVER-ntdll.dll"
OBSERVER_SHA="00f0bd160724d8da404f10548834168142eed41291a6c9ed74ea54f3529e8581"
