#!/usr/bin/env bash
# ABZU ABBA heap-CS observer — probe (NOT_GOLDEN, diagnostic only).
...
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-probe-20260713j"
...
OBSERVER_SHA="1f493167ace9b9d6e987e9cfb72077971694c158b0b608236984ef345885492d"
