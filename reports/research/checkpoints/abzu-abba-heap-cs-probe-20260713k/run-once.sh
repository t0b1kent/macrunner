#!/usr/bin/env bash
# ABZU ABBA heap-CS probe k — head buffer (first 96 ops) + tail ring + per-TID counters.
set -euo pipefail

ROOT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner-abzu"
OUT="/Users/timurtoby/Documents/MacRunner/Main/MacRunner/reports/research/checkpoints/abzu-abba-heap-cs-probe-20260713k"
...
OBSERVER_SHA="58afe72bfcce4ec1dbd84b69654a76169376224f10c4ae4394bc68ca58663316"
