...
OUT="$MAIN/reports/research/checkpoints/abzu-builtin-unixlib-resolve-verify-20260713-NOT_GOLDEN"
...
FIX_UNIX_SHA="b60e43c3c1730194c04842099d2e5a8cde2af491b305f0ea9f24467927c484ff"
...
HB_SOURCE_SHA="5d1e65879f5c75acf3bc6f506c4863031c941f1eec2bc6fdc3c3ba8144f441ea"
...
BUILD_LOG_SHA="242b2c61c4253b7cd68b4eff853ebcd9ca94f3efa4f8bb340f1c8d9ee5b45c90"
...
if [ "$(git -C "$MAIN" rev-parse HEAD)" != "$MAIN_HEAD" ] ||
   ...
   [ "$(sha "$MAIN/reports/research/build-logs/abzu-builtin-unixlib-resolve-ntdll-20260713.log")" != "$BUILD_LOG_SHA" ]; then
