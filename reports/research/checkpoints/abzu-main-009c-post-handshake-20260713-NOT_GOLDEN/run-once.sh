...
OUT="$MAIN/reports/research/checkpoints/abzu-main-009c-post-handshake-20260713-NOT_GOLDEN"
...
MAIN_GUARD_SHA="61a10c580db7beeca7e53e49531252fbd9345d4188cf4d142e5b45bcc67625d4"
...
if [ "$(git -C "$MAIN" rev-parse HEAD)" != "$MAIN_HEAD" ] ||
   ...
   [ "$(sha "$MAIN/tools/test_hb_event_lifecycle_probe_source.py")" != "$EVENT_GUARD_SHA" ] ||
   [ "$(sha "$MAIN/tools/test_hb_main_009c_probe_source.py")" != "$MAIN_GUARD_SHA" ]; then
...
export MACRUNNER_HB_MAIN_009C_PROBE=1
export WINEMSYNC=1
...
echo "MAIN_009C_PROBE=1" >> "$OUT/RUNTIME-STATUS.txt"
(
    cd "$ROOT"
