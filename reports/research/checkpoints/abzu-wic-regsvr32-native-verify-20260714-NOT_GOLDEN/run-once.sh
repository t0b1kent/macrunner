...
OUT="$MAIN/reports/research/checkpoints/abzu-wic-regsvr32-native-verify-20260714-NOT_GOLDEN"
...
RUNNER_SHA="99c390ba10498177833fdfaa1f0fb8ef4e990dc7f3d264fc364703f27535b7d0"
MAIN_RUNNER_SHA="fbd679b8d3780f251859f6fc221a960397ba3356a4209931ce4346da6a6c2421"
...
WIC_GUARD_SHA="788df964e77705728a5e9148743bcd1c22da5ba80810175d14987028584a6030"
...
if [ "$(git -C "$MAIN" rev-parse HEAD)" != "$MAIN_HEAD" ] ||
   ...
   [ "$(sha "$MAIN/scripts/mr-run.sh")" != "$MAIN_RUNNER_SHA" ] ||
   [ "$(sha "$GAME")" != "$GAME_SHA" ] ||
   ...
   [ "$(sha "$MAIN/tools/test_mr_run_windowscodecs_regsvr32_source.py")" != "$WIC_GUARD_SHA" ] ||
...
unset MACRUNNER_MR_RUN_REGSVR32_WINCODECS
...
export MACRUNNER_MR_RUN_REGSVR32_WINCODECS=1
...
echo "REGSVR32_WINCODECS=1" >> "$OUT/RUNTIME-STATUS.txt"
echo "REGSVR32_LAUNCHER_ARCH=aarch64-windows" >> "$OUT/RUNTIME-STATUS.txt"
