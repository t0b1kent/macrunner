...
OUT="$MAIN/reports/research/checkpoints/abzu-ws232-unixlib-class-fix-verify-20260713-NOT_GOLDEN"
...
FIX_UNIX_SHA="c27cf0576259dc77c88625ac57cd41c35fb8fcb46f0ea81314e18aa62e2a6254"
FIX_PE_SHA="3a9c3a020295dc1ac5f3405cd3e0de60fd839cabd692499d116443f96c70d4e5"
...
LOADER_SOURCE_SHA="6b1c10c23d33a24cfb8ce718d88dfd69591fa05b369b7c716c8fc7f5f4179361"
HB_SOURCE_SHA="583ec00fd31d4e5edb37e9fb1293daa56413df693058cce052feae410cd49a05"
SYNC_SOURCE_SHA="2d17e9a6bb78be743ef5a0906fdaa1a744a482b1cabb3d12e0c7f643039581ab"
CLASS_GUARD_SHA="6a07c65094ad242870ee26dca6e20357e91605799cc7891f6599d153bd4621fc"
...
BUILD_LOG_SHA="cd4a5dc339489a66ddd87dcb11bb4a57978f7938b0f85b30b12e2f0d39485aa6"
...
if [ "$(git -C "$MAIN" rev-parse HEAD)" != "$MAIN_HEAD" ] ||
   ...
   [ "$(sha "$MAIN/tools/test_hb_builtin_x64_unixlib_lifecycle_source.py")" != "$CLASS_GUARD_SHA" ] ||
   ...
   [ "$(sha "$MAIN/reports/research/build-logs/abzu-ws232-unixlib-class-fix-ntdll-20260713.log")" != "$BUILD_LOG_SHA" ]; then
...
export MACRUNNER_HB_BUILTIN_X64_DLLMAIN=1
...
echo "BUILTIN_X64_DLLMAIN=1" >> "$OUT/RUNTIME-STATUS.txt"
