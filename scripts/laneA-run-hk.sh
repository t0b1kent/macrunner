...
for try in $(seq 1 "$MAX"); do
  ...
  set -o pipefail
    ...
    MACRUNNER_HB_ZONE_CHECK="${MACRUNNER_HB_ZONE_CHECK:-0}" \
    MACRUNNER_HB_TRACE_NULLCALL="${MACRUNNER_HB_TRACE_NULLCALL:-0}" \
    MACRUNNER_HB_ASYNCOP_POLL="${MACRUNNER_HB_ASYNCOP_POLL:-0}" \
    MACRUNNER_HB_MANAGED_TICK="${MACRUNNER_HB_MANAGED_TICK:-0}" \
    MACRUNNER_HB_AWAKE_CENSUS="${MACRUNNER_HB_AWAKE_CENSUS:-0}" \
    MACRUNNER_HB_ENGINE_CALLBACK_PROBE="${MACRUNNER_HB_ENGINE_CALLBACK_PROBE:-0}" \
    MACRUNNER_HB_POST_LEVEL_MILESTONE_TRACE="${MACRUNNER_HB_POST_LEVEL_MILESTONE_TRACE:-0}" \
    MACRUNNER_HB_SNAPSHOT_MEASURE_SKIP="${MACRUNNER_HB_SNAPSHOT_MEASURE_SKIP:-0}" \
    MACRUNNER_HB_TRACE_JIT_HOT_BLOCKS="${MACRUNNER_HB_TRACE_JIT_HOT_BLOCKS:-0}" \
    MACRUNNER_HB_BLOCK_CHAIN="${MACRUNNER_HB_BLOCK_CHAIN:-0}" \
    MACRUNNER_HB_CHAIN_WIDE="${MACRUNNER_HB_CHAIN_WIDE:-1}" \
    MACRUNNER_HB_CHAIN_WRITE="${MACRUNNER_HB_CHAIN_WRITE:-1}" \
    MACRUNNER_HB_TRACE_CHAIN_EDGE="${MACRUNNER_HB_TRACE_CHAIN_EDGE:-0}" \
    MACRUNNER_HB_CHAIN_PATCH="${MACRUNNER_HB_CHAIN_PATCH:-1}" \
    MACRUNNER_HB_RECOVER_NO_FRAME="${MACRUNNER_HB_RECOVER_NO_FRAME:-1}" \
    MACRUNNER_HB_HEXPTHK_FAST_SKIP="${MACRUNNER_HB_HEXPTHK_FAST_SKIP:-0}" \
    MACRUNNER_HB_JIT_NATIVE_MEM_IR="${MACRUNNER_HB_JIT_NATIVE_MEM_IR:-0}" \
    MACRUNNER_HB_JIT_NATIVE_MEM_SIDE="${MACRUNNER_HB_JIT_NATIVE_MEM_SIDE:-0}" \
    MACRUNNER_HB_JIT_NATIVE_MEM_SHAPE="${MACRUNNER_HB_JIT_NATIVE_MEM_SHAPE:-}" \
    MACRUNNER_HB_JIT_NATIVE_MEM_IR_QWORD_LOADS="${MACRUNNER_HB_JIT_NATIVE_MEM_IR_QWORD_LOADS:-0}" \
    MACRUNNER_HB_RECOVER_HOST_FRAME="${MACRUNNER_HB_RECOVER_HOST_FRAME:-1}" \
    MACRUNNER_HB_TRACE_DISPATCH_STATS="${MACRUNNER_HB_TRACE_DISPATCH_STATS:-0}" \
    MACRUNNER_HB_TRACE_DISPATCH_STATS_INTERVAL="${MACRUNNER_HB_TRACE_DISPATCH_STATS_INTERVAL:-}" \
    MACRUNNER_HB_ACCERR_STORM_SAMPLE="${MACRUNNER_HB_ACCERR_STORM_SAMPLE:-0}" \
    MACRUNNER_HB_CHAIN_MAX_PATCHES="${MACRUNNER_HB_CHAIN_MAX_PATCHES:-}" \
    MACRUNNER_HB_TRACE_CHAIN="${MACRUNNER_HB_TRACE_CHAIN:-0}" \
    MACRUNNER_SYNC_INCLUDE_AUDIO_DRV="${MACRUNNER_SYNC_INCLUDE_AUDIO_DRV:-0}" \
    MACRUNNER_HB_TRACE_JIT_HOT_BYTES="${MACRUNNER_HB_TRACE_JIT_HOT_BYTES:-0}" \
    MACRUNNER_HB_TRACE_JIT_HOT_INTERVAL="${MACRUNNER_HB_TRACE_JIT_HOT_INTERVAL:-}" \
    MACRUNNER_HB_SNAPSHOT_SKIP_INTERP="${MACRUNNER_HB_SNAPSHOT_SKIP_INTERP:-1}" \
    MACRUNNER_HB_REGION_FREE_QUARANTINE="${MACRUNNER_HB_REGION_FREE_QUARANTINE:-0}" \
    MACRUNNER_HB_TLS_HOTCACHE="${MACRUNNER_HB_TLS_HOTCACHE:-1}" \
    MACRUNNER_HB_NEG_CACHE="${MACRUNNER_HB_NEG_CACHE:-1}" \
    MACRUNNER_HB_DISABLE_HOT_CACHE="${MACRUNNER_HB_DISABLE_HOT_CACHE:-0}" \
    ...
    ${MACRUNNER_LANEA_NO_CAFFEINATE:+} $(command -v caffeinate >/dev/null && echo "caffeinate -dimsu") \
    "$ROOT/scripts/mr-run.sh" \
